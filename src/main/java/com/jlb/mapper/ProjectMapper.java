...
public interface ProjectMapper {
    ...
    @Results(id = "project_all_info", value = {
            ...
            @Result(property = "projectPrincipal", column = "project_principal_id", one = @One(select = "com.jlb.mapper.MemberMapper.queryMemberById")),
            @Result(property = "projectPrincipalTeam", column = "project_principal_team_id", one = @One(select = "com.jlb.mapper.TeamMapper.queryTeamByTeamId"))
    })
