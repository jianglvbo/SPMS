...
public interface TaskMapper {
    ...
    @Results(id = "task_all_info", value = {
            @Result(property = "taskCreator", column = "task_create_id", one = @One(select = "com.jlb.mapper.MemberMapper.queryMemberById")),
            @Result(property = "taskExecutor", column = "task_execute_id", one = @One(select = "com.jlb.mapper.MemberMapper.queryMemberById")),
            @Result(property = "taskTester", column = "task_test_id", one = @One(select = "com.jlb.mapper.MemberMapper.queryMemberById")),
            @Result(property = "taskRelateProject", column = "task_relate_project_id", one = @One(select = "com.jlb.mapper.ProjectMapper.queryProjectByProjectId")),
            @Result(property = "taskFather", column = "task_father_id", one = @One(select = "com.jlb.mapper.TaskMapper.queryTaskDetailByTaskId"))
    })
